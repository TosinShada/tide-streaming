...
export declare function initialize<R extends ResponseTypes = undefined>({ token, start_id }: {
    token: Address;
    start_id: u32;
}, options?: {
    /**
...
export declare function getStream<R extends ResponseTypes = undefined>({ stream_id }: {
    stream_id: u32;
}, options?: {
    /**
     * The fee to pay for the transaction. Default: 100.
...
export declare function getStreamsByUser<R extends ResponseTypes = undefined>({ caller }: {
    caller: Address;
}, options?: {
    /**
     * The fee to pay for the transaction. Default: 100.
 ...
 */
export declare function deltaOf<R extends ResponseTypes = undefined>({ stream_id }: {
    stream_id: u32;
}, options?: {
    /**
     * The fee to pay for the transaction. Default: 100.
 ...
 */
export declare function balanceOf<R extends ResponseTypes = undefined>({ stream_id, caller }: {
    stream_id: u32;
    caller: Address;
}, options?: {
    /**
...
export declare function createStream<R extends ResponseTypes = undefined>({ sender, recipient, amount, token_address, start_time, stop_time }: {
    sender: Address;
    recipient: Address;
    amount: i128;
    token_address: Address;
...
export declare function withdrawFromStream<R extends ResponseTypes = undefined>({ recipient, stream_id, amount }: {
    recipient: Address;
    stream_id: u32;
    amount: i128;
}, options?: {
 ...
 */
export declare function cancelStream<R extends ResponseTypes = undefined>({ caller, stream_id }: {
    caller: Address;
    stream_id: u32;
}, options?: {
    /**
