...
export declare class Contract {
    ...
    getStream<R extends ResponseTypes = undefined>({ stream_id }: {
        stream_id: u32;
    }, options?: {
        /**
         * The fee to pay for the transaction. Default: 100.
    ...
    getStreamsByUser<R extends ResponseTypes = undefined>({ caller }: {
        caller: Address;
    }, options?: {
        /**
         * The fee to pay for the transaction. Default: 100.
 ...
 */
    ...
    createStream<R extends ResponseTypes = undefined>({ sender, recipient, amount, token_address, start_time, stop_time }: {
        sender: Address;
        recipient: Address;
        amount: i128;
        token_address: Address;
 ...
 */
    cancelStream<R extends ResponseTypes = undefined>({ caller, stream_id }: {
        caller: Address;
        stream_id: u32;
    }, options?: {
        /**
